...
export default function CampusesPreview({ onApply, onNavigate }) {
  return (
    <section id="campuses-preview" className="campuses-preview">
      <div className="section-head">
        ...
        <p className="section-sub">
          The Arqam Schools operates multiple campuses across Lahore, each
          offering the same quality education from Kindergarten to
          Matriculation. Tap a campus below to start the admission process.
        </p>
      </div>
      ...
      <div className="campuses-preview__cta">
        <button
          type="button"
